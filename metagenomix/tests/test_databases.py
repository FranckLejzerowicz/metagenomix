...
class TestDatabases(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.params = {'default': {'time': "48", 'nodes': "1", 'mem_num': "5",
                                   'cpus': "1", 'mem_dim': "gb", 'env': "mg"}}
    ...
    def test_get_first_column(self):
        ...
        first_column = conf.get_first_column()
        ...
        with self.assertRaises(IOError) as e:
            conf.get_first_column()
        self.assertEqual(
            'File "%s" is empty' % conf.meta_fp, str(e.exception))
    ...
    def test_get_params(self):
        ...
        params = {'default': {'time': "48", 'nodes': "1", 'mem_num': "5",
                              'cpus': "1", 'mem_dim': "gb", 'env': "mg"},
                  'shogun': {'time': "1", 'nodes': "1", 'mem_num': "5",
                             'cpus': "1", 'mem_dim': "gb", 'env': "mg"}}
        config_input = self.config_input
        config_input.update({'user_params_yml': self.user_params_yml})
        conf = AnalysesConfig(**config_input)
        conf.parse_yamls()
        conf.get_params()
        self.assertEqual(params, conf.params)
